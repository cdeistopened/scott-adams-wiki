...
- `analogies-dont-persuade.md` — The anti-pattern: why analogies backfire and visuals win (Filter 1 negative case)
- `audience-of-one.md` — Persuasion must target the actual audience, not observers (scoring context for all filters)
- `ego-as-tool.md` — Master persuaders adjust ego strategically; losers treat it as identity
- `jab-hook-persuasion-ratio.md` — Cross-wiki: GaryVee's 3:1 ratio applied to pacing-and-leading (audit the pace/lead balance)
- `data-hook-persuasion.md` — Cross-wiki: Hormozi's data hooks as visual, analogy-proof, anchor-setting persuasion
