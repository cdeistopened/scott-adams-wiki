...
1. Notice the inputs you're receiving (what are you watching, reading, who are you around?)
2. Ask: "Would a moist robot exposed to these inputs behave the way I'm behaving?"
3. If yes, and you don't like the behavior, change the inputs — don't try to override them with willpower
...
- `authoring-others.md` — The geopolitical application: you create people through your inputs, not react to their outputs
- `ego-as-tool.md` — Ego as a programmable variable: master persuaders adjust it strategically
