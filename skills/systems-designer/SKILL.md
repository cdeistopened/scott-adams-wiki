...
2. **Exercise** — raises baseline energy for everything else
3. **Diet** — what you eat determines your energy curve
4. **Social** — right people energize, wrong people drain
5. **Work structure** — do the hardest thing at peak energy

### Step 3: System Design

Now convert the goal into a system. The system must:

1. **Be doable every day** (or on a regular schedule). If it requires heroic effort, it's not a system.
2. **Be process-focused, not outcome-focused.** "Write 500 words every day" is a system. "Write a bestselling book" is a goal.
3. **Survive bad days.** A good system has a minimum viable version for low-energy days. Adams: "On my worst day, I still draw. It might be a bad drawing, but I drew."
4. **Compound over time.** Each iteration should leave you slightly better positioned than before — more skilled, more connected, more knowledgeable — regardless of any specific outcome.
5. **Not depend on motivation.** "The system should be designed so that even a lazy, unmotivated version of you would still do it most days."
...
- `authoring-others.md` — Relationship systems: you program people through your inputs, not react to their outputs
- `golden-age.md` — The macro system: technology-driven prosperity invisible to those focused on political noise
