...
## The Discipline Lenses

### Lens 1: The Economist's Check
...
**Loserthink symptoms:**
- Expecting people to act against their incentives because it's "the right thing to do"
- Ignoring the incentive structure and focusing on stated values
- Wondering why a policy isn't working when the incentives reward the opposite behavior
...
**Loserthink symptoms:**
- "You can't prove it ISN'T true" (unfalsifiable)
- "The experts agree" without specifying which experts or what they'd accept as disconfirming evidence
- Confusing correlation with causation
- Cherry-picking confirming evidence, ignoring disconfirming evidence
- "It's just common sense" (the least scientific statement possible)
...
**Loserthink symptoms:**
- "This policy should reduce crime" without checking if it actually did
- Plans that sound logical but have never been tested
- Assuming second and third-order effects don't exist
- Designing systems for how people SHOULD behave rather than how they DO behave

**Fix:** "Has anyone actually tried this? What happened? If nobody has tried it, what's the smallest test you could run?"

### Lens 4: The Psychologist's Check
...
- Anchoring (over-weighting the first number or frame you encountered)
- Cognitive dissonance (rewriting reality to protect a cherished belief)
- Dunning-Kruger (less competent people overestimate their ability)
- Mind-reading (attributing motives to others without evidence)
- Sunk cost fallacy (continuing because you've already invested, not because it's working)
...
- Not knowing the base rate for similar situations
- Assuming that because technology has changed, human nature has changed
- "Nobody has ever faced this challenge before" (they almost certainly have)

**Fix:** "When has something similar happened before? What was the outcome? What's the base rate for situations like this?"

### Lens 6: The Entrepreneur's Check
...
**Loserthink symptoms:**
- "This is a good idea" without asking "compared to what?"
- Spending time on something because it's positive without asking if the same time would produce more value elsewhere
...
- **reframe-engine** — Both diagnose thinking errors, but the reframe engine offers 7 lenses for getting unstuck on a specific problem. Use the workshop to identify the error; use the reframe engine to find the new angle.
- **media-decoder** — Apply cognitive dissonance diagnosis to news stories and public narratives. The decoder uses the same tells in the context of media analysis.
- **prediction-scorecard** — Base rate thinking and unfalsifiability are prediction errors too. The scorecard catches these same errors when evaluating a specific forecast.

## Related Frameworks

- `loserthink.md` — The core framework article
- `cognitive-dissonance.md` — The tells catalog used across multiple lenses
- `confirmation-bias.md` — A specific thinking error diagnosed in Lens 4
- `mind-reading-fallacy.md` — A specific thinking error diagnosed in Lens 4
- `one-best-evidence.md` — A diagnostic tool for cutting through multi-variable confusion
- `halfpinion.md` — A complaint without an alternative; loserthink disguised as criticism
- `progression-of-awareness.md` — Four stages from "the other side is evil" to "I can spot my own triggers"
- `analogies-dont-persuade.md` — A common loserthink pattern: using analogies that hand ammunition to the opposition
