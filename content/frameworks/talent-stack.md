...
type: framework
title: "Talent Stack"
aliases: ["skill stack", "stacking skills"]
domain: lifestyle
mentions: 455
episodes: 380
related: [systems-vs-goals, affirmations]
cases: []
...
1.  **Mediocre Art Skills:** He can draw well enough to convey a joke, but he isn't a master illustrator.
2.  **Writing/Humor:** He is a decent writer with a grasp of punchy, economical dialogue.
3.  **Business Knowledge:** Having worked at Pacific Bell and earned an MBA from Berkeley, he understood office culture, bureaucracy, and management failure.
4.  **Attention/Marketing:** He understands the "X Factor" of grabbing an audience. As Scott says, "If you can't get attention there's nothing else that matters."
